      ...
      (
        <div style={{
          ...
          <div style={{ display: 'flex', flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
            ...
            {imageUrl ? (
              <img src={imageUrl} alt="Device Image" style={{ width: '100%', height: '90%', objectFit: 'contain', zIndex: 10 }} />
            ) : (
              <div style={{ 
                  width: '70%', height: '55%', borderRadius: 40, border: '2px dashed #333',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 60 }}>
            <div style={{ 
              display: 'flex', backgroundColor: MINT, padding: '15px 70px', borderRadius: 20,
              boxShadow: '0 15px 40px rgba(62, 180, 137, 0.4)'
            }}>
              <span style={{ fontSize: 65, fontWeight: 900, color: '#000' }}>KES {price}</span>
            </div>
          </div>
