    ...
    return new ImageResponse(
      (
        <div style={{
          ...
          background: 'linear-gradient(135deg, #1E1E1E 0%, #3A3A3A 100%)', // Modern Gradient Background
          color: 'white',
          ...
          <div style={{ display: 'flex', flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
            <div style={{
              ...
              background: 'radial-gradient(circle, rgba(255,255,255,0.1) 0%, transparent 80%)', // Subtle effect
              borderRadius: '50%', display: 'flex'
            }} />

            {imageUrl ? (
              <img src={imageUrl} alt="Device Image" style={{ width: '95%', height: '90%', objectFit: 'contain', zIndex: 10 }} />
            ) : (
              <div style={{
